...
| -------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------|
| [dkafe_win64_binary_v0.54.zip](https://github.com/10yard/dkafe/releases/download/v0.54/dkafe_win64_binary_v0.54.zip) | 0.54    | Windows 64 bit (x64) systems: 10, 11      |
| [dkafe_win32_binary_v0.54.zip](https://github.com/10yard/dkafe/releases/download/v0.54/dkafe_win32_binary_v0.54.zip) | 0.54    | Windows 32 bit (x86) systems: Vista, 7, 8 |
| [dkafe_winxp_binary_v0.54.zip](https://github.com/10yard/dkafe/releases/download/v0.54/dkafe_winxp_binary_v0.54.zip) | 0.54    | Windows XP only                           |
| [dkafe_rpi4_image_v0.52.gz](https://github.com/10yard/dkafe/releases/download/v0.52/dkafe_rpi4_image_v0.52.gz)       | 0.52    | Raspberry Pi 4 and 400 only               |
...
There are 122 configurable game slots in total. 
...
All roms in the list should be given an emulator number (e.g. 1 for DKWolf, as defined in `settings.txt`), a slot position (between 1 and 122) and a basic descriptive name.  Set the slot position to 0 or 999 if you want the rom to only appear in the menu. 
