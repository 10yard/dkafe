...
| -------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------|
| [dkafe_win64_binary_v0.36.zip](https://github.com/10yard/dkafe/releases/download/v0.36/dkafe_win64_binary_v0.36.zip) | 0.36    | Windows 64 bit (x64) systems: 10, 11      |
| [dkafe_win32_binary_v0.36.zip](https://github.com/10yard/dkafe/releases/download/v0.36/dkafe_win32_binary_v0.36.zip) | 0.36    | Windows 32 bit (x86) systems: Vista, 7, 8 |
