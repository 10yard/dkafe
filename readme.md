...
| -------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------|
| [dkafe_win64_binary_v0.40.zip](https://github.com/10yard/dkafe/releases/download/v0.40/dkafe_win64_binary_v0.40.zip) | 0.40    | Windows 64 bit (x64) systems: 10, 11      |
| [dkafe_win32_binary_v0.40.zip](https://github.com/10yard/dkafe/releases/download/v0.40/dkafe_win32_binary_v0.40.zip) | 0.40    | Windows 32 bit (x86) systems: Vista, 7, 8 |
| [dkafe_rpi4_image_v0.39.gz](https://github.com/10yard/dkafe/releases/download/v0.39/dkafe_rpi4_image_v0.39.gz)       | 0.39    | Raspberry Pi 4 and 400 only               |
