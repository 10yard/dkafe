...
| -------------------------------------------------------------------------------------------------------------------- | ------- | -------------------------------------------|
| [dkafe_win64_binary_v0.79.zip](https://github.com/10yard/dkafe/releases/download/v0.79/dkafe_win64_binary_v0.79.zip) | 0.79    | Windows 64 bit (x64) systems (Recommended) |
