...
All roms in the list should be given an emulator number (e.g. 1 for DKWolf, as defined in `settings.txt`), a slot position (between 1 and 122) and a basic descriptive name.  Set the slot position to 0 if you want the rom to only appear in the menu. 
