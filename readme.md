...
| -------------------------------------------------------------------------------------------------------------------- | ------- | -------------------------------------------|
| [dkafe_win64_binary_v0.80.zip](https://github.com/10yard/dkafe/releases/download/v0.80/dkafe_win64_binary_v0.80.zip) | 0.80    | Windows 64 bit (x64) systems (Recommended) |
| [dkafe_win32_binary_v0.79.zip](https://github.com/10yard/dkafe/releases/download/v0.79/dkafe_win32_binary_v0.79.zip) | 0.79    | Windows 32 bit (x86) systems               |
| [dkafe_rpi4_image_v0.78.gz](https://github.com/10yard/dkafe/releases/download/v0.78/dkafe_rpi4_image_v0.78.gz)       | 0.78    | Raspberry Pi 4 and 400 only                |
...
Button numbers for common controllers are available at https://www.pygame.org/docs/ref/joystick.html#nintendo-switch-pro-controller-pygame-2-x
