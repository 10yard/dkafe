...
| -------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------|
| [dkafe_win64_binary_v0.43.zip](https://github.com/10yard/dkafe/releases/download/v0.43/dkafe_win64_binary_v0.43.zip) | 0.43    | Windows 64 bit (x64) systems: 10, 11      |
| [dkafe_win32_binary_v0.43.zip](https://github.com/10yard/dkafe/releases/download/v0.43/dkafe_win32_binary_v0.43.zip) | 0.43    | Windows 32 bit (x86) systems: Vista, 7, 8 |
| [dkafe_rpi4_image_v0.42.gz](https://github.com/10yard/dkafe/releases/download/v0.42/dkafe_rpi4_image_v0.42.gz)       | 0.42    | Raspberry Pi 4 and 400 only               |
