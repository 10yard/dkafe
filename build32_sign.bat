...
"C:\Program Files (x86)\Windows Kits\10\bin\x86\signtool" sign /tr http://timestamp.digicert.com /td sha256 /n "Open Source Developer" dist\launch32.exe dist\dkwolf\dkwolf.exe
pause
