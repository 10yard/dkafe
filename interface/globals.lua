...
data_min_score = os.getenv("DATA_MIN_SCORE")
data_min_award = os.getenv("DATA_MIN_AWARD")
data_bonus_score = os.getenv("DATA_BONUS_SCORE")
data_bonus_award = os.getenv("DATA_BONUS_AWARD")
