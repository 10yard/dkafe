...
if START_STAGE > (STAGES - 1):
    if not (START_STAGE == 8 and ENABLE_TRAINING):
        globals()["START_STAGE"] = 0
...
PLUGINS = (
    ...
    ("dkonginsanitygala", "dkinsanity,galakong"),
    ...
    ("dkongallenl22tv","allenkong:22,dktv"),
...
SLOTS = [
    ...
    (18, 226), (34, 226), (53, 226), (70, 226), (87,226), (116,226), (136, 226), (156, 226), (174, 226), (192, 226),
    (26, 186), (42, 186), (58, 186), (82, 186), (114, 186), (130, 186), (154, 186), (170, 186), (186, 186),
